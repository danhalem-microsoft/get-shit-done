...
```bash
ls ${planning_root}/phases/XX-current/*-PLAN.md 2>/dev/null | sort
ls ${planning_root}/phases/XX-current/*-SUMMARY.md 2>/dev/null | sort
```
...
```bash
cat ${planning_root}/phases/XX-current/*-SUMMARY.md
```
