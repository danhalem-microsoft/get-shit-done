...
**If issues == 0:** Proceed to `scan_phase_artifacts`
</step>
...
If user declines: stop, allow them to resolve issues, then re-run /gsd-verify-work.

If user confirms or no open items found: proceed to security gate check.
