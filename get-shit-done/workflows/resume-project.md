...
- Any planning operation when ${planning_root}/ already exists
...
```bash
ls ${planning_root}/phases/XX-name/*-CONTEXT.md 2>/dev/null || true
```
...
- Cloning repo without full ${planning_root}/ state
  </reconstruction>
