...
> Visual and interaction contract for frontend phases. Filled in by hand from the orchestrator's main thread (the dedicated UI-researcher and UI-checker agents have been retired in the Phase 1 cull).
