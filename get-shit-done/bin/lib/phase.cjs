...
function cmdFindPhase(cwd, phase, raw) {
  ...
  try {
    ...
    const result = {
      found: true,
      directory: toPosixPath(path.join(path.relative(cwd, path.join(cwd, getPlanningRoot(cwd))), 'phases', match)),
