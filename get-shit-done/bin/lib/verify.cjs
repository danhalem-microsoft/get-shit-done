...
const os = require('os');
const { safeReadFile, loadConfig, normalizePhaseName, escapeRegex, execGit, findPhaseInternal, getMilestoneInfo, stripShippedMilestones, extractCurrentMilestone, output, error, checkAgentsInstalled, CONFIG_DEFAULTS, getPlanningRoot, tryGetPlanningContext, planningDir } = require('./core.cjs');
...
function cmdValidateHealth(cwd, options, raw) {
  ...
  const planBase = path.join(cwd, planningRoot);
