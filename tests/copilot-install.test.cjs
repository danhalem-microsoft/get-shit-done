...
describe('E2E: Copilot full install verification', () => {
  ...
  test('installs all expected agent files', () => {
    ...
    const expected = [
      ...
      'gsd-critic-code.agent.md',
      'gsd-critic-discuss.agent.md',
      'gsd-critic-plan.agent.md',
      'gsd-critic-scope.agent.md',
      'gsd-critic-strategy.agent.md',
      'gsd-critic-verify.agent.md',
